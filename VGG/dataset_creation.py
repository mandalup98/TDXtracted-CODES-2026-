...
base_path = ""
benchmarks = [ "VGG-11", "VGG-13", "VGG-16","VGG-19"]
...
for bench in benchmarks:
    file_path = os.path.join(base_path, bench, "memory_activity.stalls_l2_miss.csv")
...
df_dataset.to_csv("VGG_memory_activity.stalls_l2_miss.csv", index=False)  # Optional: CSV for readability
