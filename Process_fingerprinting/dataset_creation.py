...
base_path = ""
benchmarks = ["lbm","omnetpp", "perlbench", "mcf", "namd", "povray", "imagick", "xalancbmk", "nab", "x264", "gcc"]
...
for bench in benchmarks:
    file_path = os.path.join(base_path, bench, "uops_retired.stalls.csv")
...
df_dataset.to_csv("Process_uops_retired.stalls.csv", index=False)  # Optional: CSV for readability
